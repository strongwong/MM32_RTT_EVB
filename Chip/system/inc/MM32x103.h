...
/* Uncomment the line below according to the target mm32x103 device used in your
   application 
  */
...
/*  Tip: To avoid modifying this file each time you need to switch between these
 ...
 - Medium-density devices are mm32x103 microcontrollers
...
typedef struct
{
	__IO uint32_t TXREG; 			// 0x00
	__IO uint32_t RXREG;			// 0x04
	__IO uint16_t CSTAT;			// 0x08
	uint16_t  RESERVED0;
	__IO uint16_t INTSTAT;			// 0x0c
	uint16_t  RESERVED1;
	__IO uint16_t INTEN;			// 0x10
	uint16_t  RESERVED2;
	__IO uint16_t INTCLR;			// 0x14
	uint16_t  RESERVED3;
	__IO uint16_t GCTL;				// 0x18
	uint16_t  RESERVED4;			
	__IO uint16_t CCTL;				// 0x1c
	uint16_t  RESERVED5;
	__IO uint16_t SPBRG;			// 0x20
	uint16_t  RESERVED6;
	__IO uint16_t RXDNR;			// 0x24
	uint16_t  RESERVED7;
	__IO uint16_t SCSR;				// 0x28
	uint16_t  RESERVED8;
	__IO uint16_t LEN;				// 0x2c
...
#define  RCC_APB2ENR_CPTEN                   ((uint32_t)0x00008000)            /*!< COMP clock enable */

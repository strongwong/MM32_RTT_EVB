...
/**
* @brief  send read cmd,generate read clock.
* @param I2Cx: where x can be 1 or 2 to select the I2C peripheral.
* @retval : 
*/
...
*   This parameter can be one of the following values:
* @arg I2C_STATUS_FLAG_ACTIVITY: i2c activity  flag  				                             
* @arg I2C_STATUS_FLAG_TFNF : tx buffer no full flag  					 
* @arg  I2C_STATUS_FLAG_TFE: tx empty flag 			                                 
* @arg I2C_STATUS_FLAG_RFNE : rx buffer no full empty   				     
* @arg I2C_STATUS_FLAG_RFF: tx buffer full 			                             
* @arg I2C_STATUS_FLAG_M_ACTIVITY	: i2c master activity  flag			
* @arg I2C_STATUS_FLAG_S_ACTIVITY	: i2c salve activity  flag 				         	
